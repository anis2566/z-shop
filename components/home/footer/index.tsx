...
export const Footer = () => {
    return (
        <div className="px-4 space-y-6 mt-6 w-full max-w-screen-xl mx-auto">
            <Separator />
            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-7 justify-items-center">
            ...
            <Separator />
            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-7 min-h-[100px] justify-items-center">
