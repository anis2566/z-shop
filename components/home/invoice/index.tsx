...
import { Address, Order, OrderProduct, Product, User } from '@prisma/client';
            ...
            <Page size="A4" style={{ padding: "50px" }}>
                ...
                >
                    <View style={{ display: "flex", flexDirection: "column" }}>
                        <Text style={{ fontWeight: "bold", fontSize: "16px" }}>{order.address?.recepient}</Text>
                        <Text style={{ fontSize: "12px", color: "#6b7280" }}>{order.address?.address}</Text>
                    </View>
